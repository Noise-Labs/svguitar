...
var SVGuitarChord = /** @class */ (function () {
    ...
    SVGuitarChord.prototype.drawNut = function (x, y, size, color, textSize, fontFamily, fingerOptions) {
        ...
        if (fingerOptions.text) {
            this.renderer.text(fingerOptions.text, x, y, textSize, (_l = fingerOptions.textColor) !== null && _l !== void 0 ? _l : nutTextColor, fontFamily, Alignment.MIDDLE, true);
        }
    };
    SVGuitarChord.prototype.drawTitle = function (size) {
        ...
        // draw the title
        var _e = this.renderer.text(title, constants.width / 2, 5, size, color, fontFamily, Alignment.MIDDLE), x = _e.x, y = _e.y, width = _e.width, height = _e.height, remove = _e.remove;
